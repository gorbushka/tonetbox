...
#    private_key_file='/path/to/private-key.pem',
    ...
    parser = argparse.ArgumentParser(description='Parse config and import to Netbox')
    parser.add_argument('conf_file',help='config to parse')
    parser.add_argument('-s',dest='syntax',action='store',help='syntax CiscoConfParse: nxos,ios etc...',required=True)
    parser.add_argument('-did',dest='did',action='store',help='device id in Netbox',type=int)
    parser.add_argument('-p',action='store_true',help='push data to Netbox')
